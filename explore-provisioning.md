...
1. This **Config Template** will be used by the switch `AUSYD01-SW-1`. To see where this is assigned, navigate to **Devices** > **AUSYD01-SW-1**. Click on **Edit** in the top-right corner. 
